...
/**
 * Disconnect the Bbduino
 *
 * @return {null}
 * @publish
 */
Driver.prototype.disconnect = function(callback) {
  this.connection.disconnect(callback); // call the adaptor's api (why ?)
};
 ...
 * @publish
 */
Driver.prototype.servo = function(pos, callback) {
  this.connection.servo(pos, callback); // call the adaptor's api (why ?)
};
